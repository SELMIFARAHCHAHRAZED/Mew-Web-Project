...
require("../admin/controller/DataBaseModel.php");
require_once("../admin/models/Animal.php");
require_once("../admin/models/Refuge.php");
...
if(  isset($_POST['nom']) && isset($_POST['age']) && isset($_POST['sexe']) && isset($_POST['race']) && isset($_POST['refuge']) && isset($_POST['poids'])
    && isset($_POST['photo']) && isset($_POST['description']) ) {
    if( !empty($_POST['nom']) && !empty($_POST['age']) && !empty($_POST['sexe']) && !empty($_POST['race']) && !empty($_POST['refuge']) && !empty($_POST['poids'])
    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="ftco-nav">
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item active"><a href="services.html" class="nav-link">Adoption</a></li>
            ...
            <div class="col-md-4 d-flex align-self-stretch px-4 ftco-animate fadeInUp ftco-animated">
                ...
                <div class="d-block services text-center" style="background-color: #00bd56;" >
                    ...
                    <div class="media-body p-4">
                        <a href="ajouterAnimal.php"> <h3 class="heading"  style="color : white;">Ajouter un animal</h3>    </a>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input required  type="text" class="form-control" name="nom" id="nom" placeholder="Nom">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label class="label" for="age">Age</label>
                                <input required type="text" class="form-control" name="age" id="age" placeholder="Age">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input required type="text" class="form-control" name="race" id="race" placeholder="Race">
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input required type="text" class="form-control" name="poids" id="poids" placeholder="Poids">
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input required type="file" accept="image/png, image/jpeg" class="form-control" name="photo"
                                       id="photo">
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <textarea required name="description" class="form-control" id="description" rows="5"
                                          placeholder="Description de votre animal ..."></textarea>
                            </div>
                        </div>
          <!--***************ena badalt type submit b onclick="Envoyer() **********-->
                        <div class="col-md-12" >
                         <input onclick="Envoyer()"  value="Ajouter" class="btn btn-primary"
...
<script src="ajoutanimal.js"></script>
</body>
</html>