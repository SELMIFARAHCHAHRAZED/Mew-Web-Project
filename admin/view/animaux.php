...
$refugeControlelr = new RefugeController();

$refuges = $refugeControlelr->afficherRefuge();
if(isset($_GET['deleteThisId'])) {
    if(!empty($_GET['deleteThisId'])){
        $animalController->supprimerAnimal($_GET['deleteThisId']);
        $supp = 1;
    }
}

if( isset($_POST['id']) && isset($_POST['nom']) && isset($_POST['age']) && isset($_POST['sexe']) && isset($_POST['race']) && isset($_POST['refuge']) && isset($_POST['poids'])
&& isset($_POST['photo']) && isset($_POST['description']) ) {
    if( !empty($_POST['id']) && !empty($_POST['nom']) && !empty($_POST['age']) && !empty($_POST['sexe']) && !empty($_POST['race']) && !empty($_POST['refuge']) && !empty($_POST['poids'])
         && !empty($_POST['description']) ) {

        $animal = new Animal($_POST['nom'],$_POST['age'],$_POST['sexe'],$_POST['race'],$_POST['refuge'],$_POST['poids'],$_POST['photo'],$_POST['description']);
        $animal->setId($_POST['id']);
        if ( $animal->getId() == -1) {
            $animalController->ajouterAnimal($animal);
            $ajout = 1;        }

        else {
            if(!empty($_POST['photo']) ) {
            $animalController->modifierAnimal($animal);
            $modif = 1 ;
            }
            else {
            $animalController->modifierAnimalNoPhoto($animal);
                $modif = 1 ;
            }
        }
...
<div id="right-panel" class="right-panel">
                        ...
                        <div class="card-body">
                            ...
                            <div id="pay-invoice">
                                <div class="card-body">
                                    ...
                                    <hr>
                                    <form action="animaux.php" method="post"  id="theForm"   >
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" required class="form-control" name="age" id="age" placeholder="Age">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label class="label" for="sexe">Sexe</label>
                                                    <select  required class="form-control" name="sexe" id="sexe" placeholder="sexe">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input required="true" type="text" class="form-control" name="race" id="race" placeholder="Race">
                                                </div>
                                            </div>
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <label class="label" for="refuge">Refuge</label>
                                                    <select required  class="form-control" name="refuge" id="refuge">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label class="label" for="poids">Poids</label>
                                                    <input  type="text" class="form-control" name="poids" id="poids" placeholder="Poids" required>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <textarea required name="description" class="form-control" id="description" rows="5" placeholder="Description de votre animal ..."></textarea>
                                                </div>
                                            </div>
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <strong class="card-title">Liste des animaux</strong>
                            ...
                            <div class="input-group" style="margin-top: 1.5%;">
                                ...
                                <input onkeyup="filterSearch()" placeholder="Chercher des nom ou des races ..."  class="form-control" type="text" id="searchInput" >
                            </div>
                        </div>
                        <div class="table-stats order-table ov-h">
                            <table class="table " id="myTable">
                                ...
                                <tr>
                                    <td class="serial"><?php echo $a['id']; ?></td>
                                    <td class="avatar">
                                        <div class="round-img">
                                            <a href="" ><img class="rounded-circle" src="../../photo/<?php echo $a['photo']; ?> " alt=""></a>
                                        </div>
                                    </td>
                                    <td> <?php echo $a['nom'];  ?> </td>
                                    <td>  <span class="name"><?php echo $a['sexe'];  ?></span> </td>
                                    <td> <span class="name"><?php echo $a['race'];  ?></span> </td>
                                    <td><span class="name"><?php echo $a['age'];  ?></span></td>
                                    <td>
                                        <span class="name"><?php echo $a['refugeNom'];  ?></span>
                                    </td>

                                    <td>  <span class="name"><?php echo $a['poids'];  ?></span> </td>

                                    <td>  <span class="name"><?php echo $a['description'];  ?></span> </td>
                                    <td>   <button onclick="editAnimal(<?php  echo  "'" .$a['id'] . "','" .   $a['nom']   . "','" .   $a['age']  . "','" .  $a['sexe']   . "','" .   $a['race']  . "','" .   $a['refugeId']  . "','" .    $a['poids'] . "','" .    $a['photo']  . "','" .   $a['description'] . "'" ; ?>)" type="button" class="btn btn-outline-success"><i class="fa fa-edit"></i></button> <a href="animaux.php?deleteThisId=<?php echo $a['id']; ?>"  ><button type="button" class="btn btn-outline-danger"> <i class="fa fa-trash-o"></i></button></a> </td>
                                </tr>
                                <?php
    ...
    <script>
        function editAnimal(id,nom,age,sexe,race,refuge,poids,photo,description) {
            document.getElementById("id").value = id;
            document.getElementById("nom").value = nom;
            document.getElementById("age").value = age;
            document.getElementById("race").value = race;
            document.getElementById("sexe").value = sexe;
            document.getElementById("refuge").value = refuge;
        ...
        function reset(){
            ...
            document.getElementById("sexe").value = "Male";
            document.getElementById("refuge").selectedIndex = "0";
