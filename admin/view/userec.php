...
echo 'hi ', $_SESSION['b'];
?>
<button><a href="reclamationuser.php">mes reclamations</a></button>
...
<div class="form-group">
  ...
  <div class="col-md-4">
    ...
    <img src="../image/<?= $result["file"] ?>" width = "200" height = "200" class="shop-item-image">
...
" href = "repondreuser.php?idRec=<?= $result["idRec"] ?>"></a>

       <button><a href="reclamationuser.php"></a>fermer</button>
</div>
    </fieldset>
