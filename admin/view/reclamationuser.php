...
<button><a href="ajoutreclamation.php">faire une reclamation</a></button>
<div class="bg1">
<h2 align="center">mes reclamations</h2>
...
" href = "userec.php?idRec=<?= $reclamation['idRec'] ?>"></a>
              <a type="submit" class="glyphicon glyphicon-trash" href = "reclamationuser.php?idRec=<?= $reclamation['idRec'] ?>"></a></td>
<?php 
					}}
				?>
				</table></div></div>
